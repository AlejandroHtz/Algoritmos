                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <a href="#" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">1.-Algoritmo a resolver</h2>
                                ...
                                del desafío de Bob es b = (b[0], b[1], b[2]) .  <br>
                                La tarea consiste en encontrar sus puntos de comparación comparando a[0] con
                                b[0] , a [1] con b [1] y a [2] con b [2] <br>

                                Si a[i] > b[i] , entonces Alice recibe 1 punto. <br>
                                Si a[i] < b[i] , entonces Bob recibe 1 punto. <br>
                                Si a[i] = b[i] , ninguna persona recibe un punto. <br>
                        ...
                        <a href="/" class="scale-50 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                

                                <h2 class="mt-10 text-xl font-semibold text-gray-900 dark:text-white">Algoritmo resuelto con php</h2>

                                <p class="mt-6 text-gray-500 dark:text-gray-400 text-xl leading-relaxed">
                                    <?php

                                    $alicia = 0;
                                    $bob = 0;

                                    $calificacion_alice= '17,28,30';
                                    $calificacion_bob= '99,16,8';
                                    
                                    $arrayalicie = explode ( ',',$calificacion_alice);
                                    $arraybob = explode ( ',',$calificacion_bob);

                                    
                                    
                                   if(count($arrayalicie) == count($arraybob)){
                                    ...
                                    */
                                    $contador= count($arrayalicie);
                                    for($i = 0; $i < $contador; $i++){
                                     
                                     if($arrayalicie[$i] > $arraybob[$i]){
                                        $alicia =  $alicia + 1;
                                ...
                                echo "Alicia: ".$alicia. ", Bob: ".$bob;

                                   
                                   }else{
                                    echo "No se podran comparar ya que alguno tiene mas calificaciones";
                                   }
                        ...
                        <a href="/" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">2.-Algoritmo a resolver</h2>
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    ...
                                    mayúsculas o minúsculas. Devolver resultado en JSON. <br>
